...
public class DynamicIndyMaker {
	  ...
	  public void makeClassWithInvokeDynamic(String nameOfIndyCallsite, MethodType desc, Class<?> bsmClass, String bsmName, MethodType bsmType, Object... bsmArgs) {
...
//	    MethodVisitor mv = cw.visitMethod(ACC_PUBLIC, "invokedynamic", descriptor, null, null);
	    int slot = 0;
...
//	      return MethodHandles.lookup().findVirtual(clazz, "invokedynamic", desc);
	    ...
	    public static CallSite bsm(Lookup lookup, String name, MethodType methodType, Object arg) {
	    	...
	    	// return a trivial constant callsite, with a constant method handle as its target
	    ...
	    public static void main(String[] args) throws Throwable {
	    	...
	    	// indyMaker.makeClassWithInvokeDynamic(nameOfCallSite, desc, bsmClass, bsmName, bsmType, bsmArgs)

	    	indyMaker.makeClassWithInvokeDynamic("_", MethodType.methodType(BigDecimal.class),
	    			DynamicIndyMaker.class, "bsm", MethodType.methodType(CallSite.class, Lookup.class, String.class, MethodType.class, Object.class),
